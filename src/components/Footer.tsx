    ...
    <footer className="bg-navy-900 text-white">
      <div className="container-custom section-padding !pb-0">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 pb-16">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3"><Mail className="w-4 h-4 text-gold-500 mt-1 flex-shrink-0" /><span className="text-navy-400 text-sm">hello@wowfitnesska42.com</span></div>
        ...
        <div className="border-t border-navy-800 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-navy-500 text-sm">&copy; {new Date().getFullYear()} Wow Fitness KA 42. All rights reserved.</p>
